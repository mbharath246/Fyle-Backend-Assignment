...
class Assignment(db.Model):
    ...
    def principal_mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_valid(grade is not None, 'assignment with empty grade cannot be graded')
        assertions.assert_valid(assignment.state in (AssignmentStateEnum.SUBMITTED, AssignmentStateEnum.GRADED), "only submitted assignments can be graded")
    ...
    @classmethod
    def get_all_submit_graded_assignments(cls):
